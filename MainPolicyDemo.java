...
class MainPolicy implements ActionListener
{
JFrame f;
JButton b1,b2,b3,b4;
JLabel l1;
...
im=new ImageIcon("WhatsApp Image main.jpeg");
...
l1=new JLabel("Benifits of Bank");
l1.setBounds(100,50,300,30);
l1.setFont(f2);
l1.setForeground(Color.RED);
bg.add(l1);

b1=new JButton("Policy Details");
...
b2=new JButton("Update Policy Details");
b2.setBounds(125,220,250,30);
b2.addActionListener(this);
b2.setFont(f1);
bg.add(b2);

b3=new JButton("Delete Policy Details");
...
DeletePolicy j=new DeletePolicy();
f.dispose();
}//b3
