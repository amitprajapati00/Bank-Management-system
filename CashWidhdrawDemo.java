...
import java.sql.*;
class CashWidhdraw implements KeyListener,ActionListener
{
JFrame f;
JLabel l1,l2,l3,l4;
JTextField t2,t3,t4;
...
im=new ImageIcon("WhatsApp Image widhdraw.jpeg");
...
l4=new JLabel("Total Amount Widhdraw");
...
class CashWidhdrawDemo
{
public static void main(String[] a)
{
CashWidhdraw l=new CashWidhdraw();
}
}
