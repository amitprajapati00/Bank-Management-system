...
class UpdateLoan implements KeyListener, ActionListener
{
JFrame f;
JLabel l1,l2,l3,l4;
...
UpdateLoan()
{
f=new JFrame("Update Loan Information");
f.setSize(700,500);
...
im=new ImageIcon("WhatsApp Image loan 2.jpeg");
...
try
{
st=con.prepareStatement("Update loan set rate_of_intrest=?,terms_or_condition=?,description=?  where loan_type=?");
st.setString(4,lontyp);
st.setString(1,roi);
st.setString(2,tac);
st.setString(3,des);
st.executeUpdate();
...
class UpdateLoanDemo
{
public static void main(String[] a)
{
UpdateLoan I=new UpdateLoan();
}
}
