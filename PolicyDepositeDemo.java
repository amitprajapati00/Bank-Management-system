...
class PolicyDeposite implements KeyListener,ActionListener
{
JFrame f;
...
im=new ImageIcon("WhatsApp Image Policy Deposite.jpeg");
...
try
{
st=con.prepareStatement("insert into policydeposite values(?,?,?,?,?)");
