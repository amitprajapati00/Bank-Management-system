...
class UpdateOpenAccount implements KeyListener,ActionListener
{
JFrame f;
...
UpdateOpenAccount()
{
f=new JFrame("Update Customer Detail");
f.setSize(1100,750);
...
im=new ImageIcon("WhatsApp Image update account1.jpeg");
...
l7.setBounds(650,50,150,30);
l7.setFont(f1);
l7.setForeground(Color.RED);
bg.add(l7);

t5=new JTextField();
t5.setBounds(850,50,200,30);
t5.setFont(f1);
bg.add(t5);
...
l8.setBounds(650,130,150,30);
l8.setFont(f1);
l8.setForeground(Color.RED);
bg.add(l8);

t6=new JTextField();
t6.setBounds(850,130,200,30);
t6.setFont(f1);
bg.add(t6);
t6.addKeyListener(this);

l9=new JLabel("Account Type");
l9.setBounds(650,210,150,30);
l9.setFont(f1);
l9.setForeground(Color.RED);
bg.add(l9);

t7=new JTextField();
t7.setBounds(850,210,200,30);
t7.setFont(f1);
bg.add(t7);
...
l10.setBounds(650,290,150,30);
l10.setFont(f1);
l10.setForeground(Color.RED);
bg.add(l10);

t8=new JTextField();
t8.setBounds(850,290,200,30);
t8.setFont(f1);
t8.addKeyListener(this);
bg.add(t8);

l11=new JLabel("PAN Card No.");
l11.setBounds(650,370,150,30);
l11.setFont(f1);
l11.setForeground(Color.RED);
bg.add(l11);

t9=new JTextField();
t9.setBounds(850,370,200,30);
t9.setFont(f1);
t9.addKeyListener(this);
bg.add(t9);

l12=new JLabel("Initial Balance");
l12.setBounds(650,450,150,30);
l12.setFont(f1);
l12.setForeground(Color.RED);
bg.add(l12);

t10=new JTextField();
t10.setBounds(850,450,200,30);
t10.setFont(f1);
bg.add(t10);
t10.addKeyListener(this);

l13=new JLabel("IFSC Code");
l13.setBounds(650,530,150,30);
l13.setFont(f1);
l13.setForeground(Color.RED);
bg.add(l13);

t11=new JTextField();
t11.setBounds(850,530,200,30);
t11.setFont(f1);
...
try
{
st=con.prepareStatement("Update openaccount set customer_name=?,address=?,date=?,gender=?,nationality=?,mobile_number=?,aadhar_number=?,account_type=?,email_id=?,pan_card_number=?,inistiat_balance=?,ifsc_code=? where account_number=?");
st.setString(1,cn);
st.setString(2,addr);
st.setString(3,date);
st.setString(4,gen);
st.setString(5,nation);
st.setString(6,mob);
st.setString(7,adhar);
st.setString(8,acctyp);
st.setString(9,email);
st.setString(10,pan);
st.setString(11,inibal);
st.setString(12,ifsc);
st.setString(13,acc);
st.executeUpdate();
...
class UpdateOpenAccountDemo
{
public static void main(String[] s)
{
UpdateOpenAccount l=new UpdateOpenAccount();
}
}