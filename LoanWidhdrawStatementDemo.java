...
class LoanWidhdrawStatement implements ActionListener 
{
	JFrame f;
	Font f1;
	JLabel l1;
...
String heads[]={"account_number","customer_name","date","total_amount_widhdraw"};
...
class LoanWidhdrawStatementDemo
{
