...
class DeletePolicy implements ActionListener,KeyListener
{
JFrame f;
JLabel l1,l2,l3,l4;
...
im=new ImageIcon("WhatsApp Image policy main.jpeg");
...
try
{
st=con.prepareStatement("delete from policy where policy_name=?");
st.setString(1,pnm);
st.executeUpdate();
...
class DeletePolicyDemo
{
public static void main(String[] a)
{
DeletePolicy l=new DeletePolicy();
}
}
