...
import java.sql.*;
class LoanWidhdraw implements KeyListener,ActionListener
{
JFrame f;
JLabel l1,l2,l3,l4;
JTextField t2,t3,t4;
...
im=new ImageIcon("WhatsApp Image Loan Widhdraw.jpeg");
...
amtw=t4.getText();
 try
{
st=con.prepareStatement("insert into widhdraw values(?,?,?,?)");
...
class LoanWidhdrawDemo
{
public static void main(String[] a)
{
LoanWidhdraw l=new LoanWidhdraw();
}
}
