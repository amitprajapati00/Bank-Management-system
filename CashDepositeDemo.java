...
class CashDeposite implements KeyListener,ActionListener
{
JFrame f;
...
im=new ImageIcon("WhatsApp Image Deposite.jpeg");
...
MainTransaction mn=new MainTransaction();
f.dispose();
}//b3
...
if(rs.next())
   intbal=Integer.parseInt(rs.getString("inistiat_balance"));

tot=amt1+intbal;
st=con.prepareStatement("Update openaccount set inistiat_balance=? where account_number=?");
...
class CashDepositeDemo
{
public static void main(String[] a)
{
CashDeposite l=new CashDeposite();
}
}
